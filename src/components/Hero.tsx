...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-red-950/15 to-transparent pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12 lg:pt-36 lg:pb-16">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              <div className="inline-flex items-center gap-2 bg-navy-800/80 border border-navy-600/40 text-white/80 text-xs font-semibold px-4 py-2 rounded-full">
            ...
            >
              <h1
                id="hero-title"
                className="font-display font-black text-white leading-[1.06] mb-6"
              >
                <span className="text-4xl sm:text-5xl xl:text-[3.6rem] block">
                ...
                <span className="text-5xl sm:text-6xl xl:text-[4.2rem] block text-red-500 leading-tight">
                  rappel en moins de 5 minutes
                </span>
              </h1>

              {/* Service icon pills */}
              <div
                className="flex items-center gap-5 sm:gap-7 mb-6"
                aria-label="Nos services"
              >
                {serviceIcons.map(
                  ({ label, Icon, gradient, glow, hoverGlow, highlight }) => (
                    <div
                      key={label}
                    ...
                    >
                      ...
                      >
                        {/* gloss highlight */}
                        <span
                          className={`absolute top-0.5 left-1.5 w-5 h-4 rounded-full bg-gradient-to-b ${highlight} blur-[1px] opacity-80`}
                        />
                        <Icon
                          className="w-5 h-5 text-white drop-shadow relative z-10"
                          strokeWidth={2.2}
                        />
                      </div>
            ...
            >
              <p className="text-navy-300/75 text-lg leading-relaxed mb-8 max-w-md">
                Besoin d'un plombier en Saône-et-Loire ? Laissez votre numéro :
                un artisan HPS71 vous rappelle rapidement pour évaluer votre
                problème de plomberie, chauffage ou climatisation et vous
                proposer un tarif clair par téléphone.
              </p>
            </div>
            ...
            >
              ...
              >
                <Phone className="w-5 h-5 phone-ring flex-shrink-0" aria-hidden="true" />
              ...
              <button
                ...
                aria-label="Demander un devis auprès de HPS71"
            ...
            >
              {[
                ...
                <div key={stat.label} className="flex flex-col items-start">
                  ...
                  <span className="text-navy-400/60 text-xs mt-1 uppercase tracking-wider">
                    {stat.label}
                  </span>
                </div>
              ))}
          ...
          >
            {/* Glow */}
            <div
              className="absolute inset-4 bg-red-600/10 rounded-3xl blur-3xl"
              aria-hidden="true"
            />
            ...
            <div className="relative w-full max-w-md lg:max-w-full">
              ...
              <div className="rounded-3xl overflow-hidden shadow-2xl border border-white/10 aspect-[3/4] w-full max-h-[520px]">
                <img
                  src={
                    new URL(
                      '../assets/images/WhatsApp_Image_2026-07-10_at_17.09.17_(1).jpeg',
                      import.meta.url
                    ).href
                  }
                  alt="Plombier professionnel HPS71 intervenant en plomberie, chauffage et climatisation en Saône-et-Loire"
                ...
                {/* Bottom gradient */}
                <div
                  className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-navy-950/60 to-transparent rounded-b-3xl"
                  aria-hidden="true"
                />
              </div>
            </div>
      ...
      >
        ...
        >
          <path
            d="M0 48L120 42C240 36 480 24 720 22C960 20 1200 28 1320 32L1440 36V48H0Z"
            fill="#f8fafc"
          />
        </svg>
      </div>
